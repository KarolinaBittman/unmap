...
const NEXT_STEPS = [
  ...
  { label: 'Gently surface the patterns behind where you are', active: false },
  { label: 'Rediscover your values, strengths, and ikigai', active: false },
]

// Pulsing skeleton shown while Claude generates the reflection
    ...
    <div className="space-y-4">
      ...
      <div className="text-center pb-2">
        ...
        <p className="text-brand-muted text-sm mt-2">
          You make sense. All of it does.
        </p>
      </div>

      {/* Reflection body — loading / error / Claude text */}
      ...
      {/* What's next — always visible once we're on this screen */}
      {!loading && (
      ...
      {/* CTA — only enabled once reflection is ready */}
      <button
        onClick={onBegin}
